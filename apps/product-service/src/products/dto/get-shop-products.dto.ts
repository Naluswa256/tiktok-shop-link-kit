...
// DTO for path parameters only
export class GetShopProductsParamsDto {
  @ApiProperty({
...
// DTO for query parameters only
export class GetShopProductsQueryDto {
  @ApiProperty({
...
export class GetShopProductsDto extends GetShopProductsParamsDto {
  @ApiProperty({
    description: 'Number of products to return',
    example: 20,
    minimum: 1,
