...
USAGE_TABLE_NAME=$(echo "$APP_CONFIG" | jq -r '.USAGE_TABLE_NAME // empty')
ONBOARDING_SESSIONS_TABLE_NAME=$(echo "$APP_CONFIG" | jq -r '.ONBOARDING_SESSIONS_TABLE_NAME // empty')
...
echo "  - Seller Usage: $USAGE_TABLE_NAME"
echo "  - Onboarding Sessions: $ONBOARDING_SESSIONS_TABLE_NAME"
